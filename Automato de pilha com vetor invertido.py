...
def caminho_superior():
    ...
    while cadeia[e] == 'a':
        ...
        pilha.append('C')
        print('Empilhando: ')
        for p in range(0,len(pilha)): #CORRIGI PARA IMPR AO CONTRARIO...
            print("Analise da pilha na posicao: ", p, "sendo: ", pilha[p])     
        pilhacont=pilha[::-1]
        print(pilhacont)        
        e+=1       
    while cadeia[e] == 'b':
        ...
        try:
            if len(pilha)== 0: #Pertence pq a pilha se torna vazia desempilhando seu último conteúdo
                print("Analise da pilha na posicao: 0 sendo : Vazio")
                print("[ ]")
                print("Pilha vazia")
...
def caminho_inferior():
    ...
    while cadeia[e] == 'c':
        ...
        e+=1
        try:
            if e<len(cadeia) and len(pilha)== 1:#Não pertence pq a pilha não ta zerada               print('A cadeia não pertence a linguagem: ')
                print("A Pilha não esta Vazia")
                print('A cadeia não pertence a linguagem: ')
                entrada = int(raw_input('Se você deseja inserir uma nova cadeia digite 1, se não, digite 0: '))
                if entrada == 1:
